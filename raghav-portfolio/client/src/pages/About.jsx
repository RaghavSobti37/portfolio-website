    ...
    <div className="about-page">
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          >
            <p>
              A passionate and dedicated cinematographer with hands-on experience, always eager to learn and contribute creative ideas.
              Skilled in visual storytelling, I aim to bring my expertise to dynamic filmmaking projects and deliver impactful visuals.
            </p>
            <p>
              My journey in visual arts began with a curiosity about how images can evoke emotions and tell stories.
              Over the years, I've developed a distinctive style that blends technical precision with artistic expression.
            </p>
          </motion.div>
        </div>
          ...
          <div className="timeline">
            ...
            <div className="timeline-item highlighted">
              ...
              <div className="timeline-content">
                ...
                <h4><strong>"Ek Kamra" – Music Video</strong></h4>
                <p>Directed and shot with a minimalist aesthetic and a strong emotional narrative.</p>
              </div>
            </div>
            ...
            <div className="timeline-item highlighted">
              ...
              <div className="timeline-gap" />
              <div className="timeline-content">
                <h3><strong>Videographer</strong></h3>
                <h4><strong>BoxoutFM & Premise</strong></h4>
                <ul>
                  <li>Covered live DJ set events & afterparties</li>
                  <li>Captured underground electronic music culture</li>
                  <li>Filmed interviews with Laksh Maheshwari, Smoke, Rebel7</li>
