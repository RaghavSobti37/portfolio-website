...
export const codingProjects: CodingProject[] = [
  {
    ...
    repo: 'TSC-Website',
    description:
      'Modern, visually-driven web application utilizing Next.js for server-side rendering and performance — bridging cinematic art with web technology.',
    ...
    impact: 'High-bitrate video backgrounds and interactive UI for cultural storytelling.',
    highlights: [
      'SSR + performance-focused Next.js',
      'Video backgrounds + interactive UI',
      'Mobile-first Tailwind architecture',
    ],
    preview: {
      bg: '#0a0606',
      accent: '#b64d26',
  ...
  },
  {
    ...
    repo: 'Coreknot',
    description:
      'Ops dashboard for tasks, attendance, inbox, and team context — a productivity product tying business info to user actions.',
    tech: ['React', 'Clerk', 'Product Systems'],
    github: 'https://github.com/RaghavSobti37/Coreknot',
    website: 'https://tsccoreknot.com',
    language: 'JavaScript',
    featured: true,
    frame: '/project-frames/coreknot.png',
    impact: 'Shipped workspace modules and flows for real studio workflows.',
    highlights: [
      'Tasks, attendance, inbox, team context',
      'Workspace modules for studio ops',
      'Business info tied to user actions',
    ],
    preview: {
      bg: '#0c1210',
      accent: '#126d5e',
  ...
  },
  {
    ...
    description:
      'Private browser utility that groups duplicate and visually similar photos, then downloads the best selections as a ZIP.',
    tech: ['JavaScript', 'Browser APIs', 'Image Utilities'],
    github: 'https://github.com/RaghavSobti37/photo-cleaner-app',
    website: 'https://photo-cleaner-app.vercel.app',
    language: 'JavaScript',
    featured: true,
    preview: {
      bg: '#111318',
  ...
  },
  {
    ...
    website: 'https://www.shrimexport.com',
    language: 'TypeScript',
  ...
  },
  {
    ...
    website: 'https://www.destinnyglobal.com',
    language: 'JavaScript',
  ...
  },
  {
    ...
    website: 'https://www.houseofkalaa.studio',
    language: 'HTML',
  ...
  {
    id: 'ekors',
    title: 'ERP System for EKORS',
    repo: 'Ekors-ERP',
    description:
      'Full-stack system with Role-Based Access Control for tiered permissions, secure token auth, and modular schemas for automated quotation and ticket tracking.',
    tech: ['Next.js', 'Node.js', 'Express', 'MongoDB', 'JWT'],
    github: 'https://github.com/RaghavSobti37/Ekors-ERP',
    language: 'JavaScript',
    impact: 'Dynamic management interfaces for real-time CRUD on client and inventory data.',
    highlights: [
      'RBAC for User / Admin / Super-Admin',
      'Token-based auth + modular schemas',
      'Quotations, tickets, inventory CRUD',
    ],
    preview: {
      bg: '#0f1419',
      accent: '#22c55e',
